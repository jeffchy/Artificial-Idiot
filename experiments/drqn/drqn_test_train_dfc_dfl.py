...
class DoubleDQNAgent:
    ...
    def __init__(self, state_size, action_size, trace_length, train):
...
if __name__ == "__main__":
    ...
    LOAD_MODEL_PATH = '../../models/drqn2/'
    LOAD_MODEL = LOAD_MODEL_PATH + 'drqn_curriculum_model_13.0'
    ...
    game = DoomGame()
    game.load_config("{}/{}.cfg".format(CFG_PATH, cfgfile))
    ...
    while not game.is_episode_finished():
        ...
        if t % 10000 == 0 and train:
            ...
            agent.model.save_weights("{}/{}/drqn_curriculum_weights_".format(MODEL_ROOT_PATH, savepath)+str(t/10000)+".h5", overwrite=True)
            agent.model.save("{}/{}/drqn_curriculum_model_".format(MODEL_ROOT_PATH, savepath)+str(t/10000)+".h5",overwrite=True)
            with open("{}/{}/drqn_curriculum_model_".format(MODEL_ROOT_PATH, savepath)+str(t/10000)+".json","w") as f:
                f.write(agent.model.model.to_json())
                f.close()
